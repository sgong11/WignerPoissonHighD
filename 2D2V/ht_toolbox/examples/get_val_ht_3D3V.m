function f_val = get_val_ht_3D3V(f,id_1,id_2,id_3,id_4,id_5,id_6,rk)
    ...
    U34   = U34.*U4_rp;
    U34   = reshape(U34,N,rk(11),rk(5));
    U34   = reshape(sum(U34,2),N,rk(5));
    ...
    U56   = U56.*U6_rp;
    U56   = reshape(U56,N,rk(7),rk(3));
    U56   = reshape(sum(U56,2),N,rk(3));
