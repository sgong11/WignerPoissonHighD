...
if test_type == 1
    ...
    while t(n) < T
        ...
        [f_ht{n+1},elec_mod] = HT_Conserve_correction3D_leading(f_ht_temp, h_mesh, v_modes, x_modes,v, mass(1), momentum(1,:), energy(1), curr_mass, curr_mom, curr_energy, phixm_ht,base_rel_eps,tol_ratio, min_rank, max_rank,kx);
    ...
    save(['Fast_' name_ '_' num2str(N_mesh(1)) '_CFL' num2str(CFL) '_T' num2str(T) '_H' num2str(H) '.mat'])
