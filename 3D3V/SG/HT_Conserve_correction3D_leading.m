function [f_ht_new, electric_energy_mod] = HT_Conserve_correction3D_leading(f_ht, h_mesh, v_modes, x_modes, v, target_mass, target_mom, target_energy, current_mass, current_mom, current_energy, phix_ht_current, base_rel_eps, tol_ratio, min_rank, max_rank, kx)
% HT_CONSERVE_CORRECTION3D_LEADING Enforce global conservation on a 3D3V HT tensor
%
