...
| Andrew J. Christlieb, Sining Gong, Jing-Mei Qiu, and Nanyi Zheng, **A Structure-Preserving Adaptive-Rank Approach to the High-Dimensional Wigner–Poisson System** | Preprint forthcoming on arXiv | Main high-dimensional HTACA WP method; 2D2V and 3D3V simulations with symmetry and conservation correction. |
